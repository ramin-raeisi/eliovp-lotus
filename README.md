...
This implementation contains additional settings that influence the performance. To get the best from your hardware, tune the following parameters:

* PC2-phase-related settings details are placed [here](https://github.com/NilFoundation/rust-fil-proofs/blob/master/README.md#advanced-gpu-usage-2).
* C2-phase-related settings details are placed [here](https://github.com/NilFoundation/fil-zk#environment-variables).
